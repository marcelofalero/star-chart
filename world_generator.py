...
class SystemGenerator:
    ...
    def generate_society(self) -> Dict[str, Any]:
        ...
        # Prestige Score Logic
        # High Prestige = Beautiful/Useless. Low = Ugly/Functional.
        # Spire implies high prestige, Rust Belt low. Let's weigh it slightly but keep it random as requested (1-10 stat).
        # Actually, the prompt says "A 1-10 stat replacing 'Economic Value'". I'll just random it,
        # but maybe bias it slightly based on Archetype for realism?
        # The prompt says "Assign... Prestige Score". I'll stick to random but maybe influence range.
...
class NarrativeEngine:
    ...
    def construct_prompt(self, physics: Dict, society: Dict) -> str:
        ...
        4. "description": 2 sentences contrasting the "Glistering" surface with rotting foundation.
    ...
    def generate_mock_narrative(self, physics: Dict, society: Dict) -> Dict[str, str]:
        ...
        return {
            ...
            "description": f"The surface of this {physics['star_type']} system glimmers with fake data. Beneath the facade, the simulation rots."
        }
